...
| **3. Балансировка нагрузки и параллельное выполнение** | Реализация базового алгоритма распределения задач и многопоточности.                                    | Round Robin или Data Locality, многопоточная обработка задач на узлах.                           | 4 дня            | Инженер по производительности |
